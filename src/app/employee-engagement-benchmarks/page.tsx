...
export const metadata: Metadata = {
  ...
  description: 'How engaged are employees with internal podcasts in your industry? Brandscast shows your engagement rate vs your sector average — so you always know where you stand.',
    ...
    <>
      ...
      <div className="hero-page">
        <div className="hero-page-inner">
          ...
          <p className="lead">
            Most internal comms teams track how many people listened. Fewer know whether that number is good. Brandscast shows your engagement rate next to the average for your sector, so you have the right reference point to improve.
          </p>
          <p className="hero-meta">
            Sector benchmarks are available in your Brandscast analytics dashboard. Set your company sector in settings and your benchmark appears automatically.
          </p>
        </div>
      </div>
        ...
        <section className="content-section">
          <div className="section-inner two-cols">
            ...
            <aside className="highlight-box">
              ...
              <ul>
                <li>Whether your engagement is strong, average or below par for your sector.</li>
                <li>A realistic goal to aim for based on real data from similar teams.</li>
                <li>Whether a drop in engagement is a you problem or an industry-wide trend.</li>
                <li>A number you can bring to leadership as context for your results.</li>
              </ul>
        ...
        <section className="content-section">
          <div className="section-inner two-cols">
            <div>
              ...
              <ul>
                <li><strong>Live benchmark</strong> — updates automatically as members listen.</li>
                <li><strong>Per-podcast breakdown</strong> — see which channels are above or below average.</li>
                <li><strong>Downloadable reports</strong> — share your engagement data with context.</li>
              </ul>
              <a href="/employee-listening-analytics/" style={{ display: 'inline-block', marginTop: '24px', color: 'var(--brand)', fontWeight: 600, textDecoration: 'none' }}>
            ...
            <aside className="highlight-box">
              ...
              <p>
                Knowing your engagement rate matters more when you know what good looks like in your sector. Brandscast shows both numbers side by side so you always have the right reference point.
              </p>
              <p>
                No spreadsheets. No manual benchmarking. Your number and the industry average, in your dashboard.
              </p>
            </aside>
          </div>
        </section>
          ...
          <div className="section-inner two-cols">
            ...
            <aside className="highlight-box">
              ...
              <ul>
                ...
                <li>Start each episode by saying what the listener will get from it.</li>
              </ul>
            </aside>
          </div>
        </section>
        ...
        <section className="content-section">
          <div className="section-inner">
            ...
            <div className="faq">
              ...
              <details>
                <summary>Do I need to set anything up to see my benchmark</summary>
                <p>
