    ...
    <>
      ...
      <div className="hero-page">
        <div className="hero-page-inner">
          ...
          <p className="lead">
            The Brandscast MCP connector lets you manage your{" "}
            <a href="/private-podcasts-for-teams/">private podcasts</a>,
            episodes, and listeners directly from Claude — no dashboard needed.
          </p>
        </div>
      </div>
      ...
      <main>
        <section className="content-section">
          <div className="section-inner two-cols">
            <div>
              ...
              <p>
                Once connected, you can ask Claude to perform actions on your
            ...
            <div>
              ...
              <ol>
                ...
                <li>
                  Search for <strong>Brandscast</strong> in the directory
                </li>
                <li>
                  Click <strong>Connect</strong> and authenticate with your
                  Brandscast account
                </li>
                <li>Start using Brandscast tools in any Claude conversation</li>
              </ol>
              <p>
                Authentication uses OAuth 2.0. Your Brandscast credentials are
        ...
        <section className="content-section">
          <div className="section-inner">
            <h2>Requirements</h2>
            <p>
              You need an active Brandscast account with a Starter, Growth or
              Pro plan. No technical setup is required — the connector works out
              of the box once you authenticate.
            </p>
            ...
            <p>
              ...
              <a href="mailto:hello@brandscast.com">hello@brandscast.com</a> and
