  ...
  return (
    ...
    <section className="content-section cta-section">
      <div className="section-inner cta-inner">
        <h2>Use private podcasts for internal comms with Brandscast</h2>
        <p className="lead">
        ...
        <p style={{ margin: '0', color: 'var(--muted)' }}>Create your internal comms podcast in minutes and publish your next company update as a short episode.</p>
      </div>
    </section>
      </main>
