      ...
      <main className="container">
        ...
        <nav className="toc" aria-label="Table of Contents">
          ...
          <ol>
            ...
            <li>
              <a href="#collection">Collection of your data</a>
            </li>
            <li>
            ...
            <li>
              <a href="#categories">Categories of data processed</a>
            </li>
            <li>
            ...
            <li>
              <a href="#rights">Data protection rights</a>
            </li>
            <li>
            ...
            <li>
              <a href="#contact">Further information</a>
            </li>
          </ol>
        </nav>
        ...
        <article>
          <section id="intro">
            <p>
              We consider it important that you read and understand this
              information. At <strong>Brandscast</strong>, you have control over
              your personal information and we will not use your data in an
              illegitimate or unfair way. This Policy follows{" "}
              <strong>Regulation (EU) 2016/679</strong> the General Data
          ...
          <section id="controller">
            ...
            <p>
              <strong>Controller:</strong> Pol Rodríguez Rius
              <br />
              <strong>Tax ID:</strong> 47651931W
              <br />
              <strong>Address:</strong> C/ de la Llotja s/n, Coworking VIT, Vic
              08500, Spain
              <br />
              <strong>Email:</strong>{" "}
              ...
              <a href="https://brandscast.com">brandscast.com</a>
            </p>
          </section>
          ...
          <section id="collection">
            ...
            <ul>
              <li>
                When you contact us through communication channels provided on
                this website such as email.
              </li>
              <li>
          ...
          <section id="purpose">
            ...
            <ul>
              ...
              <li>
                Manage contractual relationships with clients who subscribe to
                our plans.
              </li>
              <li>
          ...
          <section id="legal-basis">
            ...
            <p>
              ...
              Communication with you by electronic means and maintaining site
            ...
            <p>
              ...
              subscribe to a paid plan we process necessary data to execute and
              fulfill the contract.
            </p>
            <p>
              <strong>Legal obligation</strong> GDPR art 6 1 c. For billing
              accounting or tax requirements and to respond to lawful requests
              from authorities.
            </p>
          </section>
          ...
          <section id="categories">
            ...
            <p>
              We collect the minimum data required. We do not process special or
              sensitive categories.
            </p>
            <ul>
              <li>
                <strong>Access data</strong> passwords.
              </li>
              <li>
                <strong>Contact data</strong> email address.
              </li>
              <li>
                <strong>Connectivity data</strong> IP address and browsing
                activity.
              </li>
              <li>
                <strong>Transaction data</strong> purchase details payment data
                and related correspondence.
              </li>
              <li>
                <strong>Additional data</strong> any information you voluntarily
                share with us.
              </li>
            </ul>
            <p className="note">
              If you do not provide required data we may not be able to deliver
              the service properly. Please inform us of any changes so we can
          ...
          <section id="retention">
            ...
            <ul>
              <li>
                <strong>Contact and support</strong> retained until your query
                is resolved then securely archived for up to three years.
              </li>
              <li>
              ...
              <li>
                ...
                after the end of the contractual relationship under the Spanish
                Commercial Code.
              </li>
            </ul>
          </section>
          ...
          <section id="rights">
            ...
            <p>
              You have the right to access rectify erase and port your data to
              restrict or object to processing and to withdraw consent at any
              time. You may also lodge a complaint with the{" "}
            ...
            <p>
              ...
              <a href="mailto:hello@brandscast.com">hello@brandscast.com</a> or
              send a written request with a copy of your ID to our postal
              address above.
            </p>
          </section>
          ...
          <section id="security">
            ...
            <p>
              We apply technical and organizational measures to protect your
              personal data including encrypted transport via SSL secure
              password hashing access control using least privilege practices
              and contractual security commitments from our providers.
            </p>
          </section>
          ...
          <section id="updates">
            ...
            <p>
              ...
              practices. If changes are significant we will notify you through
