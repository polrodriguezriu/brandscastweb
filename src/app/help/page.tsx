  ...
  },
  {
    ...
    tutorials: [
      ...
      },
      {
        ...
        tip: "Tracks can organise onboarding, compliance and product education. Choose episode length from the task, audience feedback and pilot data rather than a generic engagement benchmark.",
      },
    ],
  },
  {
    ...
    tutorials: [
      ...
      },
      {
        ...
        tip: "Revoke access when someone leaves your organisation. A personal feed URL is a bearer credential and can be forwarded, so regenerate or revoke it if exposed.",
      },
      {
        id: "t10",
      ...
      },
      {
        ...
        steps: [
          ...
          "<strong>Inactive</strong> means Brandscast has not associated a recorded play with that Member yet. It does not establish whether the invitation arrived or why no play was recorded.",
          "Use this status as a prompt to check access or ask for feedback. A personal feed URL can be forwarded or used on a shared device, so it is not proof of who personally listened.",
        ],
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          'The dashboard shows total plays, "unique listeners" and engagement over the selected date range. Treat "unique listeners" as unique Member feeds with qualifying recorded activity, not confirmed people.',
          "Use the date picker at the top right to filter by the last 7 days, 30 days, 90 days or a custom range.",
          "The <strong>Episode downloads</strong> table shows each episode's recorded play count so you can compare activity. A higher count does not by itself prove quality, comprehension or impact.",
        ],
      ...
      },
      {
        ...
        steps: [
          ...
          "Use the data to identify which topics or formats record more qualifying plays, then form a hypothesis to test rather than assuming why.",
          "A lower count may reflect access, timing, distribution, title, topic, duration or measurement conditions. Ask the audience before drawing a conclusion.",
        ],
        tip: "Compare like-for-like episodes and change one variable at a time; a timestamp alone does not explain the difference.",
      },
      {
        id: "t14",
        ...
        steps: [
          ...
          "If most recorded requests come from mobile, validate the audience's actual listening context before changing episode length or recommending when to listen.",
        ],
        tip: "Unknown devices are excluded from the percentage calculations. Read the result as a breakdown of classified requests, not of confirmed listeners.",
      },
      {
        id: "t14b",
      ...
      },
      {
        ...
        steps: [
          "Open the Analytics dashboard and find the <strong>Audience coverage</strong> card. It counts people, not plays.",
          "In this dashboard, <strong>Coverage</strong> is the share of members with recorded listening activity in the selected period. <strong>Reached</strong> is the corresponding headcount; neither label proves comprehension.",
          ...
          "<strong>Never reached</strong> are members for whom Brandscast has never recorded listening activity. Check invitation, access and feedback before inferring why.",
          "Use the <strong>Engagement by department</strong> and <strong>by country</strong> cards to find groups with lower recorded activity, then compare them with delivery evidence from your other channels.",
        ],
  ...
  },
  {
    ...
    tutorials: [
      ...
      },
      {
        ...
        tip: "Your personal feed reflects the Tracks assigned to your member record. Treat the URL as a credential and do not forward it.",
      },
    ],
  },
];
