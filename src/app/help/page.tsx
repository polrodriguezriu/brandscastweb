...
export const metadata: Metadata = {
  ...
  description: 'Step-by-step tutorials to get the most out of Brandscast. Learn how to create podcasts, invite your team, read analytics and manage your account.',
...
const categories = [
    ...
    tutorials: [
      ...
      },
      {
        ...
        steps: [
          ...
          'Choose <strong>Podcast</strong> as the type (or Audiocourse if it is a structured course — see tutorial 7).',
  ...
  },
  {
    ...
    tutorials: [
      ...
      {
        id: 't7',
        title: 'How to create an audiocourse',
        steps: [
          'From the Podcasts section, click <strong>New podcast</strong> and choose <strong>Audiocourse</strong> as the type.',
        ...
        tip: 'Audiocourses work well for onboarding sequences, compliance training and product education. Keep each episode under 15 minutes to maintain engagement.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    tutorials: [
      ...
      {
        id: 't20',
        title: 'How to listen to Brandscast podcasts in your favourite podcast app',
        steps: [
          'When you are invited to a podcast, you receive an email with a private feed link.',
          'Copy the feed link from the email.',
          'Open your podcast app (Apple Podcasts, Overcast, Pocket Casts, Spotify or any app that supports private RSS feeds) and look for <strong>Add by URL</strong> or <strong>Add private feed</strong>.',
    ...
    <>
      ...
      <div className="hero-page">
        <div className="hero-page-inner">
          ...
          <p className="lead">
            Everything you need to set up private podcasts for your team, manage your audience and make sense of your analytics.
          </p>
          <p className="hero-meta">
            Can&apos;t find what you need? Write to us at{' '}
            <a href="mailto:hello@brandscast.com" style={{ color: 'var(--brand)' }}>hello@brandscast.com</a>{' '}
      ...
      <main>
        ...
        <section className="content-section" style={{ paddingBottom: 0 }}>
          <div className="section-inner">
            <h2 className="centered-heading" style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '.05em' }}>Jump to a section</h2>
            <div className="cards" style={{ gridTemplateColumns: 'repeat(3, 1fr)', marginTop: 0 }}>
              {categories.map((cat) => (
                <a
                  key={cat.id}
                  href={`#${cat.id}`}
                ...
                >
                  <div className={`icon ${colorMap[cat.color] !== 'brand' ? colorMap[cat.color] : ''}`}>
                    {cat.icon}
                  </div>
                  <span style={{ fontWeight: 700, fontSize: '.97rem' }}>{cat.label}</span>
                    ...
                    <div style={{ marginTop: '.8rem' }}>
                      <ol style={{ margin: '0 0 .8rem 1.2rem', padding: 0 }}>
                        {tutorial.steps.map((step, i) => (
                          <li
                            key={i}
                            style={{ marginBottom: '.6rem', color: 'var(--ink)', lineHeight: 1.75 }}
        ...
        <section className="cta-section">
          <div className="section-inner cta-inner">
            ...
            <div className="cta-actions">
              <a className="btn" href="mailto:hello@brandscast.com">Contact support</a>
            </div>
            <p style={{ margin: 0, color: 'var(--muted)' }}>Or start your free trial and explore Brandscast yourself.</p>
          </div>
        </section>
      </main>
