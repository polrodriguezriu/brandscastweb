    ...
    tutorials: [
      ...
      },
      {
        ...
        steps: [
          ...
          "<strong>Coverage</strong> is the share of your members you reached in the selected period. <strong>Reached</strong> is that same figure as a headcount.",
          "<strong>Silent this period</strong> are members who have listened before but not to anything you sent recently.",
          "<strong>Never reached</strong> are members who have never listened to anything at all. This is the number worth acting on first — they are invisible in every other channel's statistics.",
          "Use the <strong>Engagement by department</strong> and <strong>by country</strong> cards to see whether a healthy overall number is hiding a team nobody is reaching.",
        ],
