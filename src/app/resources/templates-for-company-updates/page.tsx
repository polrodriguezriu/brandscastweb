      ...
      <main>
        <section className="content-section">
          <div className="section-inner two-cols">
            <div>
              ...
              <p>
                These templates are designed for modern teams that work across
                time zones, roles, and tools. They are intentionally short and
                structured. Structure is what makes updates scalable.
              </p>
              <p>
                <strong>Before you publish an update</strong>
              </p>
              <ul>
                <li>
                ...
                <li>
                  Link to one source of truth, do not paste the full doc into
                  chat.
                </li>
              </ul>
              <p>
                You can use these in Slack, Teams, Notion, Confluence, email, or
                anywhere you publish internal communication.
              </p>
            </div>
        ...
        <section className="content-section section-tint">
          <div className="section-inner two-cols">
            ...
            <aside className="toc" aria-label="Table of contents">
              ...
              <a href="#launch">
                5. Launch announcement (product or initiative)
              </a>
        ...
        <section id="weekly">
          <div className="section-inner">
            ...
            <div className="template">
              ...
              <code>
                [Update] Weekly, [Team name], [Week of YYYY-MM-DD] Summary (1
                sentence) - [What happened this week in plain English]
                Highlights - ✅ Shipped: [1-3 bullets] - 📈 Progress: [1-3
                bullets] - 🙌 Wins: [optional, 1-2 bullets] Blockers / risks -
                ⚠️ [What is stuck and why] - ⚠️ [What could derail next week]
                Next week focus - 🎯 [Top 1-3 priorities] Need from you - [No
                reply needed] OR [Please reply by Thursday with X] OR [Decision
                needed by date: choose A/B] Links - Source of truth: [link] -
        ...
        <section id="leadership">
          <div className="section-inner">
            ...
            <p>
              Best for: leadership updates, strategy context, progress against
              priorities. Publish it regularly. Consistency beats “big
              announcements”.
            </p>
            ...
            <div className="template">
              ...
              <code>
                [Update] Leadership, [Month / Week], [Topic] Summary (1
                sentence) - [What matters most right now] What changed - [1-3
                bullets on facts and decisions] - [Optional: what is not
                changing] Why it matters - [Impact on teams / customers /
                priorities] - [Trade offs or constraints] What we are focusing
                on next - [Top 1-3 priorities] - [What success looks like] What
                I need from you - [No reply needed] OR [Please send questions in
                this thread by date] OR [Managers: cascade this by date] Links -
                Strategy / doc: [link] - FAQ / Q and A: [link]
              </code>
            </div>
            ...
            <div className="template">
              ...
              <code>
                [Update] Leadership, [Topic] TL;DR: [one sentence] Key points -
                [bullet] - [bullet] - [bullet] Full update: [link] Questions
                here: [link to thread]
              </code>
            </div>
          </div>
        ...
        <section id="decision">
          <div className="section-inner">
            ...
            <p>
              Best for: keeping teams aligned after a decision, avoiding
              re-litigating the same topic, and making ownership clear. The most
              important line is “what we decided”.
            </p>

            <div className="template">
              <h3>Decision announcement</h3>
              <p className="meta">
                Use in: decision log, project channel, company channel if broad
                impact
              </p>
              <code>
                [Decision] [Topic] Decision - We decided to [clear decision in
                one sentence]. Why - [Reason 1] - [Reason 2] - [Reason 3,
                optional] What we are not doing - [Trade off 1] - [Trade off 2]
                Impact - Affects: [teams / customers / systems] - Starts: [date]
                - Risks: [1-2 bullets] Owner - [Name], responsible for execution
                and updates. Need from you - [No reply needed] OR [Please flag
                issues by date] OR [Managers: align your plans by date] Source
                of truth - [link to doc / tracker]
              </code>
            </div>
          </div>
        </section>
        ...
        <section id="change">
          <div className="section-inner">
            ...
            <p>
              Best for: internal changes that can create confusion. The
              structure reduces anxiety. Be explicit about “what stays the same”
              and “when it starts”.
            </p>
            ...
            <div className="template">
              ...
              <code>
                [Update] Change, [Process / Policy], effective [date] Summary -
                We are changing [thing] to [new approach] starting [date]. What
                is changing - [bullet] - [bullet] - [bullet] What stays the same
                - [bullet] - [bullet] Why we are doing this - [reason 1] -
                [reason 2] What you need to do - [Action 1, with deadline] -
                [Action 2, with deadline] Support - Questions: [where to ask] -
                Office hours (optional): [time] - Documentation: [link]
              </code>
            </div>
          </div>
        </section>
        ...
        <section id="launch">
          <div className="section-inner">
            ...
            <p>
              Best for: new initiatives, internal launches, and “here is how to
              use it”. The key is to include “who it is for” and “how to get
              started”.
            </p>
            ...
            <div className="template">
              ...
              <code>
                [Update] Launch, [Name] Summary - We launched [thing]. It helps
                [who] by [benefit]. What it is - [1-2 lines describing it] -
                Audience: [who it is for] - Availability: [where it is
                available] Why it matters - [impact] - [what it replaces or
                improves] How to get started - Step 1: [action] - Step 2:
                [action] - Step 3: [action] Need from you - [Try it by date] OR
                [Share feedback in this thread] OR [Managers: roll out to your
                team] Links - Documentation: [link] - Demo / walkthrough: [link]
                - Feedback form: [link]
              </code>
            </div>
          </div>
        ...
        <section id="incident">
          <div className="section-inner">
            ...
            <p>
              Best for: outages, security incidents, customer escalations,
              operational issues. Keep the tone calm, factual, and provide next
              update time.
            </p>
            ...
            <div className="template">
              ...
              <p className="meta">
                Use in: incident channel + follow up summary in main channel if
                needed
              </p>
              <code>
                [Update] Incident, [short title], status: [Investigating /
                Identified / Monitoring / Resolved] Summary - We are
                experiencing [issue]. Impact: [who is affected]. Started:
                [time]. Current status - What we know: [bullet] - What we are
                doing: [bullet] - What we do not know yet: [bullet] Workaround
                (if any) - [workaround steps] Next update - We will post another
                update by [time] or sooner. Owner - Incident lead: [name] -
                Comms: [name] Source of truth - Incident doc: [link]
              </code>
            </div>
          </div>
        </section>
        ...
        <section id="qna">
          <div className="section-inner">
            ...
            <div className="template">
              ...
              <code>
                [Update] Answers, [Topic] Top answers 1) Q: [question] A: [clear
                answer, 2-5 lines] Link: [optional] 2) Q: [question] A: [answer]
                Link: [optional] What happens next - [next step] - [next update
                time]
              </code>
            </div>
          </div>
        ...
        <section id="audio">
          <div className="section-inner">
            ...
            <div className="template">
              ...
              <code>
                Title: [Leadership update], [Month / Week] 00:00 Intro - What
                this episode is about (one sentence) 00:30 The one thing that
                matters - [priority / focus] 02:00 What changed - [2-3 bullets]
                - Why it changed (short) 05:00 What we are doing next - [top 1-3
                actions] - What success looks like 09:00 What I need from you -
                [one clear ask] OR [no reply needed] - Where to ask questions
                10:30 Close - Next episode date / cadence
              </code>
            </div>
            ...
            <div className="template">
              ...
              <code>
                Title: [Announcement], [Topic] 00:00 Summary in one sentence
                00:30 What is changing 02:00 Why we are doing this 03:30 What
                you need to do 05:00 What stays the same 06:00 Where to get help
                and ask questions
              </code>
            </div>
            ...
            <div className="template">
              ...
              <code>
                Title: [Team spotlight], [Team name] 00:00 Intro, what the team
                does 02:00 What you shipped recently 07:00 The challenge, what
                you learned 12:00 What is next 15:00 How others can work with
                you 18:00 One ask, where to follow up
              </code>
            </div>
          </div>
        </section>
            ...
            <div>
              ...
              <ul>
                <li>
                  ...
                  for company wide updates, managers, or teams.
                </li>
                <li>
