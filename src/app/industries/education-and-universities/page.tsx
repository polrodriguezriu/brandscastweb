...
export default function EducationAndUniversitiesPage() {
  return (
    <>
      ...
      <h1>Keep campuses and education teams aligned with private internal podcasts</h1>
      <p className="lead">
        <strong>Education and universities</strong> rely on clear communication across departments, campuses and roles. Private internal podcasts help you share updates, training and culture in a flexible format staff can consume without another meeting.
      </p>
      <p className="hero-meta">
        On this page you will see how schools, universities and education organizations use internal podcasting to improve alignment, strengthen onboarding and keep teams informed across busy schedules.
      </p>
        </div>
      </div>
    ...
    <section className="content-section">
      <div className="section-inner two-cols">
        ...
        <aside className="highlight-box">
          ...
          <ul>
            <li>Policies and updates are adopted unevenly across departments.</li>
    ...
    <section className="content-section">
      <div className="section-inner two-cols">
        ...
        <aside className="highlight-box">
          ...
          <p>
            The goal is simple: fewer missed updates, less repetition, better alignment.
          </p>
        </aside>
      </div>
    </section>
    ...
    <section className="content-section">
      <div className="section-inner two-cols">
        <div>
          ...
          <p><strong>More consistent communication across departments</strong></p>
          <p>
            One message, delivered the same way. Less drift between campuses and teams, and fewer gaps in adoption.
          </p>

          <p><strong>Better onboarding and faster ramp up</strong></p>
          <p>
          ...
          <p><strong>Stronger culture and alignment</strong></p>
          <p>
        ...
        <aside className="highlight-box">
          ...
          <ul>
            ...
            <li>Communicate with busy staff who do not read long emails.</li>
          </ul>
        </aside>
      </div>
    </section>
    ...
    <section className="content-section">
      <div className="section-inner two-cols">
        <div>
          ...
          <ul>
            <li><strong>Create private podcasts</strong> for staff, departments, campuses, or leadership communication.</li>
            <li><strong>Invite listeners easily</strong> with a private link that works in podcast apps or a web player.</li>
            <li><strong>Control access</strong> so only invited staff can listen, and revoke access quickly.</li>
            <li><strong>Use AI transcripts</strong> so people can skim, search and reference key guidance fast.</li>
            <li><strong>Track listening analytics</strong> to confirm important updates are reaching teams.</li>
          </ul>
          <p>
        ...
        <aside className="highlight-box">
          ...
          <p>
            Education teams get too many emails. Internal podcasts give you a human, lightweight channel that people can actually consume.
          </p>
          <p>
            Short episodes, easy access, consistent alignment.
          </p>
        </aside>
      </div>
    </section>
    ...
    <section className="content-section cta-section">
      <div className="section-inner cta-inner">
        <h2>Start internal podcasting for education and universities</h2>
        <p className="lead">
        ...
        <p style={{ margin: '0', color: 'var(--muted)' }}>Create a private podcast in a few minutes and invite one department to test it.</p>
      </div>
    </section>
      </main>
