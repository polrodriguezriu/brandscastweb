  ...
  return (
    ...
    <section className="content-section">
      <div className="section-inner two-cols">
        <div>
          <h2>Why remote teams struggle with communication and connection</h2>
          <p>
          ...
          <p>
            Remote teams do not lack tools. They lack formats that respect time, attention and geography. This is where <strong>podcasting for remote teams</strong> changes the equation.
          </p>
        </div>
        <aside className="highlight-box">
          <h3>Signs your remote team needs a new channel</h3>
          <ul>
            <li>Important messages get lost in long threads or buried in channels.</li>
            <li>People in some time zones always watch recordings instead of joining live.</li>
            <li>Managers spend time repeating the same updates in different calls.</li>
    ...
    <section className="content-section">
      <div className="section-inner two-cols">
        ...
        <aside className="highlight-box">
          ...
          <p>
            Each episode is small on its own, but together they create a continuous, human layer of communication for your remote team.
          </p>
        </aside>
      </div>
    </section>
    ...
    <section className="content-section">
      <div className="section-inner two-cols">
        <div>
          ...
          <p><strong>Better reach across time zones</strong></p>
          <p>
          ...
          <p><strong>Less meeting fatigue</strong></p>
          <p>
          ...
          <p><strong>Stronger sense of team</strong></p>
          <p>
        ...
        <aside className="highlight-box">
          ...
          <p>
            Podcasting for remote teams works best when you already:
          </p>
          <ul>
            <li>Have colleagues in several locations or time zones.</li>
            <li>Share regular internal updates that not everyone sees or hears.</li>
            <li>Care about culture, context and clear communication.</li>
            <li>Want a lighter alternative to “just one more meeting”.</li>
          </ul>
        </aside>
      </div>
    </section>
    ...
    <section className="content-section">
      <div className="section-inner two-cols">
        <div>
          ...
          <p>
            Brandscast is built specifically to make <strong>podcasting for remote teams</strong> simple and secure. You do not have to manage public feeds or complex settings. You focus on your content while the platform takes care of delivery, access and analytics.
          </p>
        ...
        <aside className="highlight-box">
          ...
          <p>
            Remote teams do their best work when they can control their schedule. Brandscast fits into that reality by giving you a way to communicate clearly without demanding live attendance.
          </p>
          <p>
            You still keep a human voice at the centre of your communication, but leave space for people to live and work in different places and time zones.
          </p>
        </aside>
      </div>
    </section>
    ...
    <section className="content-section">
      <div className="section-inner">
        <h2 className="centered-heading">How to start podcasting for your remote team in four steps</h2>
        <p>
    ...
    <section className="content-section">
      <div className="section-inner">
        <h2>Frequently asked questions about podcasting for remote teams</h2>
        <div className="faq">
          <details>
            <summary>Will people really listen to internal podcasts</summary>
            <p>
    ...
    <section className="content-section cta-section">
      <div className="section-inner cta-inner">
        ...
        <p style={{ margin: '0', color: 'var(--muted)' }}>Create a private podcast in a few minutes and invite a small remote group to try it.</p>
      </div>
    </section>
      </main>
