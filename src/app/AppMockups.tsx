    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M10 5.5a4.5 4.5 0 1 1 0 9 4.5 4.5 0 0 1 0-9Z"
            fill="#2e5af4"
            opacity=".3"
          />
        ...
        >
          <svg
            ...
            style={{
              ...
              height: "11px",
              flexShrink: 0,
              color: item.label === active ? "#2e5af4" : "#8089a0",
            }}
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
          ...
          <span
            style={{
              ...
              color: item.label === active ? "#2e5af4" : "#5c6478",
            }}
          >
            {item.label}
          </span>
...
export function MockupPodcasts() {
  const cards = [
    {
      title: "Q2 Company Updates",
      episodes: 12,
      updated: "2d",
      type: "Podcast",
      color: "linear-gradient(135deg,#2e5af4 0%,#5b82ff 100%)",
    },
    {
              ...
              <div style={{ padding: "5px 6px 6px" }}>
                <span
                  style={{
                    fontSize: "8px",
                    fontWeight: 600,
                    color: c.type === "Podcast" ? "#2e5af4" : "#5c6478",
                    background: c.type === "Podcast" ? "#e6ecff" : "#f1f3f9",
                    padding: "1px 5px",
                    borderRadius: "999px",
                ...
                <div style={{ fontSize: "8px", color: "#8089a0" }}>
                  {c.episodes} ep · {c.updated} ago
                </div>
              </div>
            </div>
          ))}
...
export function MockupAnalytics() {
  return (
    <div
      className="app-mockup-body app-mockup-body--analytics"
      style={{ display: "flex", background: "white" }}
    >
      ...
      <div className="app-mockup-content">
        ...
        >
          <div>
            ...
            <div
              style={{ fontSize: "8.5px", color: "#8089a0", marginTop: "1px" }}
            >
              Listening behavior across all podcasts
            </div>
          </div>
        ...
        >
          {[
            ...
            { label: "Unique listeners", value: "50" },
            ...
            >
              ...
              <div
                style={{ fontSize: "8px", color: "#8089a0", marginTop: "1px" }}
              >
                {m.label}
              </div>
            </div>
        ...
        >
          ...
          >
            <span
              style={{ fontSize: "9px", fontWeight: 700, color: "#0f172a" }}
            >
              Member engagement
            </span>
            <span style={{ fontSize: "7.5px", color: "#8089a0" }}>
              Last 30 days
            </span>
          </div>
          <div
          ...
          >
            ...
            >
              <div
                style={{ fontSize: "13px", fontWeight: 800, color: "#16a34a" }}
              >
                76%
              </div>
              <div style={{ fontSize: "7.5px", color: "#15803d" }}>
                Engagement rate
              </div>
              <div
                style={{ fontSize: "7px", color: "#8089a0", marginTop: "1px" }}
              >
                Coverage 76% · 12 never reached
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div style={{ fontSize: "7.5px", color: "#8089a0" }}>
                Active members
              </div>
            </div>
            <div
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
          {[
            { name: "Sarah M.", ep: "12 ep", dot: "#22c55e" },
            { name: "James T.", ep: "8 ep", dot: "#22c55e" },
            { name: "Laura K.", ep: "3 ep", dot: "#f59e0b" },
          ].map((m) => (
            <div
              key={m.name}
              style={{
        ...
        >
          <div
            style={{
              ...
              borderRadius: "8px",
              flexShrink: 0,
              background: "linear-gradient(135deg,#2e5af4 0%,#5b82ff 100%)",
            }}
          />
          <div>
            <div
          ...
          {episodes.map((ep) => (
            ...
            >
              ...
              >
                <svg
                  viewBox="0 0 24 24"
                  style={{ width: "10px", height: "10px", fill: "#2e5af4" }}
                >
  ...
  return (
    ...
    >
      ...
      <div className="app-mockup-content">
        ...
        >
          ...
          <div style={{ display: "flex", gap: "5px", alignItems: "center" }}>
            ...
            >
              <svg
                viewBox="0 0 24 24"
                style={{ width: "9px", height: "9px", color: "#8089a0" }}
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
              >
        ...
        >
          <div
            className="app-mockup-members-row"
            style={{
              background: "#f7f9fd",
              padding: "5px 8px",
              borderBottom: "1px solid #e8ebf2",
          ...
          {members.map((m, i) => {
            const barColor =
              m.rate >= 70 ? "#22c55e" : m.rate >= 30 ? "#f59e0b" : "#ef4444";
            ...
            return (
              <div
                ...
                style={{
                  padding: "6px 8px",
                  borderBottom:
                    i < members.length - 1 ? "1px solid #f1f3f9" : "none",
                  alignItems: "center",
                }}
              >
                <div
                ...
                <span style={{ fontSize: "8px", color: "#5c6478" }}>
                  {m.dept}
                </span>
                <div
                ...
                <span
                  style={{
                    fontSize: "7.5px",
                    fontWeight: 600,
                    color: m.active ? "#16a34a" : "#8089a0",
                    background: m.active ? "#f0fdf4" : "#f7f9fd",
                    padding: "1px 5px",
                    borderRadius: "999px",
                    border: m.active
                      ? "1px solid #bbf7d0"
