    ...
    <>
      ...
      <section>
        <div className="container">
          ...
          <div className="cards">
            ...
            <article className="card">
              <div className="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M16 11V7a4 4 0 0 0-8 0v4"/><rect x="5" y="11" width="14" height="10" rx="2"/></svg></div>
              <h3>Secure and private</h3>
              <p>Private feeds for each coworker. Revoke access instantly when someone leaves.</p>
            </article>
            <article className="card">
              <div className="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 3v18h18"/><path d="M7 14l3-3 4 4 6-7"/></svg></div>
      ...
      <section id="features">
        <div className="container">
          ...
          <div className="cards">
            <article className="card">
              <div className="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/><path d="M19.4 15a1.8 1.8 0 0 0 .36 2l.04.04-1.7 1.7-.04-.04a1.8 1.8 0 0 0-2-.36 1.8 1.8 0 0 0-1.1 1.7V22h-2v-.02a1.8 1.8 0 0 0-1.1-1.7 1.8 1.8 0 0 0-2 .36l-.04.04-1.7-1.7.04-.04a1.8 1.8 0 0 0 .36-2 1.8 1.8 0 0 0-1.7-1.1H2v-2h.02a1.8 1.8 0 0 0 1.7-1.1 1.8 1.8 0 0 0-.36-2l-.04-.04 1.7-1.7.04.04a1.8 1.8 0 0 0 2 .36 1.8 1.8 0 0 0 1.1-1.7V2h2v.02a1.8 1.8 0 0 0 1.1 1.7 1.8 1.8 0 0 0 2-.36l.04-.04 1.7 1.7-.04.04a1.8 1.8 0 0 0-.36 2 1.8 1.8 0 0 0 1.7 1.1H22v2h-.02a1.8 1.8 0 0 0-1.7 1.1Z"/></svg></div>
            ...
            <article className="card">
              <div className="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3l10 6-10 6L2 9z"/><path d="M6 12v5c0 1 3 3 6 3s6-2 6-3v-5"/></svg></div>
              <h3>Audiocourses</h3>
      ...
      <section className="section-muted">
        <div className="container">
          ...
          <div className="cards">
            <article className="card"><div className="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 7v6l4 2"/></svg></div><h3>Save time</h3><p>Reduce meeting fatigue and cut internal noise.</p></article>
            ...
            <article className="card"><div className="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4z"/></svg></div><h3>Build culture</h3><p>Share authentic messages that strengthen team connection.</p></article>
      ...
      <section>
        <div className="container">
          ...
          <div className="cards">
            ...
            <article className="card"><div className="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="7" y="2" width="10" height="20" rx="2"/><path d="M11 19h2"/></svg></div><h3>Stay connected</h3><p>Feel part of the culture even when working remotely.</p></article>
            <article className="card"><div className="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M9.5 4a3.5 3.5 0 0 0-3.5 3.5v8A3.5 3.5 0 0 0 9.5 19"/><path d="M14.5 4A3.5 3.5 0 0 1 18 7.5v8A3.5 3.5 0 0 1 14.5 19"/><path d="M9.5 4c.6 2 0 3-1.5 4"/><path d="M14.5 4c-.6 2 0 3 1.5 4"/><path d="M12 7v10"/></svg></div><h3>Focus better</h3><p>No more email or chat overload. Learn when it suits you.</p></article>
            <article className="card"><div className="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M16 11V7a4 4 0 0 0-8 0v4"/><rect x="5" y="11" width="14" height="10" rx="2"/></svg></div><h3>Private and secure</h3><p>All content stays inside your organisation.</p></article>
          </div>
        </div>
      </section>
      ...
      <section className="section-muted">
        <div className="container">
          ...
          <div className="cards">
            <article className="card"><div className="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2l8 4v6c0 5-3.4 9.4-8 10-4.6-.6-8-5-8-10V6z"/><path d="M9 12l2 2 4-5"/></svg></div><h3>Private feeds</h3><p>Each feed is generated privately and shared only with your team.</p></article>
            <article className="card"><div className="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M8 8h6"/><path d="M8 12h6"/><path d="M8 16h6"/><path d="M16 7a3 3 0 0 0-2 5 3 3 0 0 0 2 5"/></svg></div><h3>GDPR compliant</h3><p>Hosted on AWS with EU regulations compliance.</p></article>
            <article className="card"><div className="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 3v18h18"/><path d="M7 14l3-3 4 4 6-7"/></svg></div><h3>Scalable and reliable</h3><p>Built to grow with your company and ensure consistent performance.</p></article>
          </div>
        </div>
      </section>
