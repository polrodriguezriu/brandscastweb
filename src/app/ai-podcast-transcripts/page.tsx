  ...
  return (
    ...
    <section className="content-section">
      <div className="section-inner two-cols">
        <div>
          <h2>Why AI audio transcripts matter for internal communication</h2>
          <p>
    ...
    <section className="content-section">
      <div className="section-inner two-cols">
        <div>
          ...
          <p>
            Brandscast uses AI to generate transcripts for your internal audio episodes. After you publish an episode, the platform processes the audio and produces a full text version of what was said.
          </p>
          <p>
            You do not need to upload separate files or manage external tools. Transcripts live next to each episode inside Brandscast, as part of the same internal audio experience.
          </p>
          <p>
        ...
        <aside className="highlight-box">
          ...
          <p>
            With AI audio transcripts in Brandscast:
          </p>
          <ul>
    ...
    <section className="content-section">
      <div className="section-inner two-cols">
        <div>
          ...
          <p>
            You can reuse parts of AI audio transcripts as written documentation. For example, you can copy key paragraphs into an internal wiki, meeting minutes or follow up emails without starting from a blank page.
          </p>
        ...
        <aside className="highlight-box">
          ...
          <ul>
            ...
            <li>A team writes release notes based on what was said in an audio episode.</li>
          </ul>
          <p>
            In each case, AI audio transcripts turn audio into a practical resource, not just a one time event.
          </p>
        </aside>
      </div>
    </section>
    ...
    <section className="content-section">
      <div className="section-inner two-cols">
        ...
        <aside className="highlight-box">
          ...
          <p>
            AI audio transcripts help you include more people in the same internal conversation.
          </p>
        </aside>
      </div>
    </section>
    ...
    <section className="content-section">
      <div className="section-inner two-cols">
        <div>
          ...
          <ul>
            <li><strong>Generate transcripts automatically</strong> for your internal audio episodes using AI.</li>
    ...
    <section className="content-section">
      <div className="section-inner">
        ...
        <p>
          You do not need a complex project to benefit from AI audio transcripts. A simple, clear process is enough to get started.
        </p>
        <div className="step-list">
          <div className="step">
            <h3>1. Choose one internal audio to enhance</h3>
            <p>
              Start with an audio that already has regular episodes, such as leadership updates or product news. This will give you quick feedback on how transcripts help your team.
            </p>
          </div>
          <div className="step">
          ...
          <div className="step">
            ...
            <p>
              Look at how people use the combination of audio and text. Reuse key parts of AI audio transcripts in written updates, FAQs or internal documentation. Over time, your internal content library becomes richer without extra effort.
            </p>
          </div>
        </div>
      </div>
    ...
    <section className="content-section">
      <div className="section-inner">
        <h2>Frequently asked questions about AI audio transcripts</h2>
        <div className="faq">
          <details>
            <summary>Do we need to upload our own transcripts</summary>
            <p>
              No. With AI audio transcripts in Brandscast, the platform generates transcripts automatically from your internal audio. You can then review and use them directly inside the product.
            </p>
          </details>
          <details>
            <summary>How accurate are AI audio transcripts</summary>
            <p>
          ...
          <details>
            <summary>Can employees search inside AI audio transcripts</summary>
            <p>
              Yes. One of the main benefits of AI audio transcripts is searchability. Employees can look for keywords, names or topics and jump to relevant parts of the content without listening to the full episode.
            </p>
          </details>
          <details>
