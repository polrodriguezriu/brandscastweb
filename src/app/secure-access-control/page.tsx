...
export const metadata: Metadata = {
  ...
  description:
    "Secure access control for internal podcasts with per-employee private feeds. Give each team member a unique private feed that stops working the moment you remove their access.",
    ...
    <>
      ...
      <div className="hero-page">
        <div className="hero-page-inner">
          ...
          <p className="lead">
            With <strong>secure access control for internal podcasts</strong>{" "}
            you decide exactly who can listen to your internal audio. Brandscast
            gives each team member a unique private feed that stops working the
      ...
      <main>
        <section className="content-section">
          <div className="section-inner two-cols">
            <div>
              ...
              <p>
                Internal podcasts often contain sensitive information. You share
              ...
              <p>
                If you use generic hosting or public podcast tools, you rely on
              ...
              <p>
                ...
                member gets their own private <a href="/rss-distribution/">RSS feed</a>. This gives you visibility
                and control at the individual level, not just at the group
                level.
              </p>
              <p>
                For <a href="/internal-communication/">internal communication</a> and <a href="/for-hr-teams/">HR teams</a>, this approach is not
        ...
        <section className="content-section">
          <div className="section-inner two-cols">
            <div>
              ...
              <p>
                Brandscast is built around a simple idea. Each team member gets
                a <strong>single, unique and private feed</strong> for the
                internal podcasts they can access. This feed is generated just
                for them and is linked to their identity inside your workspace.
              </p>
              <p>
                ...
                app or listen through the web player. New episodes for the
                internal podcasts they are allowed to access appear
                automatically in this private feed.
              </p>
              <p>
              ...
              <p>
                ...
                podcasts in Brandscast. It lets you manage access at the level
                that really matters: one person at a time.
              </p>
            </div>
            <aside className="highlight-box">
              ...
              <ul>
                ...
                <li>
                  Delivers episodes only from podcasts they are allowed to
                  access.
                </li>
                <li>
        ...
        <section className="content-section">
          <div className="section-inner">
            ...
            <p>
              When you remove a team member from an internal podcast or from
              your Brandscast workspace, their unique private feed simply stops
              working for that protected content. The feed is no longer valid as
              an access path to your internal podcasts.
            </p>
            ...
            <ul>
              ...
              <li>
                The internal podcast content is no longer accessible through
                that feed.
              </li>
              <li>
            ...
            <p>
              ...
              <strong>secure access control for internal podcasts</strong>. It
              lets People, Security and IT teams align on a simple rule. If
              someone should no longer listen, you remove them in Brandscast and
              their feed no longer grants access.
            </p>
          </div>
        </section>
        ...
        <section className="content-section">
          <div className="section-inner two-cols">
            <div>
              ...
              <p>
                When you combine private internal podcasts with secure access
              ...
              <p>
                You can use internal podcasts more confidently as a core
                channel. You do not have to water down content because you are
                unsure who might be listening. Secure access control for
                internal podcasts lets you speak honestly to your team.
              </p>
            </div>
            <aside className="highlight-box">
              ...
              <p>
                ...
                when you propose internal podcasts as a communication channel.
              </p>
            </aside>
          </div>
        </section>
          ...
          <div className="section-inner two-cols">
            <div>
              ...
              <ul>
                <li>
                  <strong>
                    Generates a unique private feed per team member
                  </strong>{" "}
                  instead of sharing one generic feed for everyone.
                </li>
                <li>
                  <strong>Links each feed to specific permissions</strong> for
                  internal podcasts, so people only get the content they should
                  see.
                </li>
                <li>
                  <strong>Stops a feed from working</strong> as soon as you
                  remove that team member’s access from your workspace or from a
                  particular podcast.
                </li>
                <li>
              ...
              <p>
                For you, this looks like a clean dashboard where you manage team
                members, internal podcasts and access levels without needing to
            ...
            <aside className="highlight-box">
              ...
              <p>
                ...
                one private feed per team member.
              </p>
              <p>
                ...
                a way into your internal podcasts.
              </p>
            </aside>
          </div>
        </section>
        ...
        <section className="content-section">
          <div className="section-inner">
            <h2 className="centered-heading">
              How to set up secure access control for internal podcasts in four
              steps
            </h2>
            <p>
            ...
            <div className="step-list">
              ...
              <div className="step">
                ...
                <p>
                  Set up the internal podcasts you need, such as leadership
              ...
              <div className="step">
                ...
                <p>
                  ...
                  Assign them access to the internal podcasts that are relevant
                  to their role.
                </p>
              </div>
              <div className="step">
                ...
                <p>
                  ...
                  Brandscast workspace or revoke their access to specific
                  podcasts. Their private feed stops working and your internal
                  audio stays protected.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="content-section">
          <div className="section-inner">
            <h2>
              Frequently asked questions about secure access control for
              internal podcasts
            </h2>
            <div className="faq">
              <details>
                <summary>
                  What exactly is a unique private feed per team member
                </summary>
                <p>
                  In Brandscast, each person gets one private podcast feed
                  generated just for them. It contains the internal podcasts
                  they are allowed to access. It is not shared with colleagues,
                  and it stops delivering content when you remove their access.
                </p>
              </details>
              <details>
                <summary>
                  What happens to the feed when we remove someone’s access
                </summary>
                <p>
                  When you remove a team member from Brandscast or from a
                  specific internal podcast, their unique private feed stops
                  working for that protected content. They no longer receive new
                  episodes and can not use that feed as a valid way to access
                  your internal podcasts.
                </p>
              </details>
              <details>
                <summary>
                  Can employees share their private feed with others
                </summary>
                <p>
                  Technically, any link can be shared. The difference with
                  per-employee feeds is that you always know which person owns
                  which feed. If you detect misuse or if someone leaves the
                  company, you can revoke that specific feed and close that
                  access path.
                </p>
              </details>
              <details>
                <summary>
                  How does this help with compliance and internal policies
                </summary>
                <p>
                  Secure access control for internal podcasts lets you align
                  internal audio with the same access rules you already use for
                  documents and tools. You know who has access, you can revoke
                  it and you can show that control exists when stakeholders ask
                  about it.
                </p>
              </details>
            </div>
