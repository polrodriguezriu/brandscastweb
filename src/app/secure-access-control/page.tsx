    ...
    <>
      ...
      <div className="hero-page">
        <div className="hero-page-inner">
          ...
          <p className="lead">
            With <strong>secure access control for internal audios</strong>{" "}
      ...
      <main>
        <section className="content-section">
          <div className="section-inner two-cols">
            <div>
              ...
              <p>
                Internal audios often contain sensitive information. You share
              ...
              <p>
                <strong>Secure access control for internal audios</strong>{" "}
          ...
          <div className="section-inner two-cols">
            <div>
              ...
              <p>
                ...
                internal audios they can access. This feed is generated just
              ...
              <p>
                ...
                unique private feed. They subscribe in their preferred audio
                app or listen through the web player. New episodes for the
                internal audios they are allowed to access appear
              ...
              <p>
                ...
                audios in Brandscast. It lets you manage access at the level
            ...
            <aside className="highlight-box">
              ...
              <ul>
                ...
                <li>
                  Delivers episodes only from audios they are allowed to
                  access.
                </li>
                <li>
        ...
        <section className="content-section">
          <div className="section-inner">
            ...
            <p>
              When you remove a team member from an internal audio or from
              ...
              an access path to your internal audios.
            </p>
            ...
            <ul>
              ...
              <li>
                The internal audio content is no longer accessible through
                that feed.
              </li>
              <li>
            ...
            <p>
              ...
              <strong>secure access control for internal audios</strong>. It
        ...
        <section className="content-section">
          <div className="section-inner two-cols">
            <div>
              ...
              <p>
                When you combine private internal audios with secure access
            ...
            <aside className="highlight-box">
              ...
              <p>
                ...
                when you propose internal audios as a communication channel.
              </p>
            </aside>
          </div>
        </section>
          ...
          <div className="section-inner two-cols">
            <div>
              ...
              <ul>
                ...
                <li>
                  ...
                  internal audios, so people only get the content they should
                  see.
                </li>
                <li>
              ...
              <p>
                ...
                members, internal audios and access levels without needing to
            ...
            <aside className="highlight-box">
              ...
              <p>
                ...
                a way into your internal audios.
              </p>
            </aside>
          </div>
        </section>
        ...
        <section className="content-section">
          <div className="section-inner">
            <h2 className="centered-heading">
              How to set up secure access control for internal audios in four
              steps
            </h2>
            <p>
            ...
            <div className="step-list">
              <div className="step">
                <h3>1. Define who should have access to internal audios</h3>
                <p>
              ...
              <div className="step">
                <h3>2. Create your internal audios in Brandscast</h3>
                <p>
                  Set up the internal audios you need, such as leadership
              ...
              <div className="step">
                ...
                <p>
                  ...
                  Assign them access to the internal audios that are relevant
                  to their role.
                </p>
              </div>
              <div className="step">
                ...
                <p>
                  ...
                  audios. Their private feed stops working and your internal
            ...
            <div className="faq">
              <details>
                ...
                <p>
                  ...
                  generated just for them. It contains the internal audios
              ...
              <details>
                ...
                <p>
                  Secure access control for internal audios lets you align
        ...
        <CtaSection
          title="Use secure access control for your internal audios with Brandscast"
