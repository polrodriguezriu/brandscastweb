        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="/hr-announcements">HR announcements</a>
              </li>
              <li>
              ...
              <li>
                <a href="/training-and-compliance">Training and compliance</a>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              <li>
                <a href="/industries/tech-companies">Tech companies</a>
              </li>
              <li>
              ...
              <li>
                <a href="/industries/retail-and-franchises">
              ...
              <li>
                <a href="/industries/education-and-universities">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="/resources/guide-to-internal-podcasts">
                  Guide to internal podcasts
                </a>
              </li>
              <li>
                <a href="/resources/async-communication-guide">
                  Async communication guide
                </a>
              </li>
              <li>
                <a href="/resources/templates-for-company-updates">
                  Templates for company updates
                </a>
              </li>
              <li>
                <a href="/resources/how-to-launch-a-private-podcast">
                  How to launch a private podcast
                </a>
              </li>
              <li>
                <a href="/resources/internal-comms-best-practices">
                  Internal comms best practices
                </a>
              </li>
              <li>
                <a href="/resources/employee-engagement-with-audio">
                  Employee engagement with audio
                </a>
              </li>
              <li>
                <a href="/resources/remote-team-communication-tips">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              <li>
                <a href="/about">About Brandscast</a>
              </li>
              <li>
